...
#ifndef __PROTO_UBX_STRUCT_DEF_H_479EEE3A_CC65683
#define __PROTO_UBX_STRUCT_DEF_H_479EEE3A_CC65683
...
typedef struct UBX_HEAD_s
{
	...
	U1 class_id;					//!< UBX Class Id
	U1 msg_id;					//!< UBX Message Id
...
//================================================================
//! CFG_ANT_POLL0: Poll Request
/*!
Poll Antenna Control Settings
Sending this (empty / no-payload) message to the receiver results in the receiver returning a message of type CFG-ANT with a payload as defined below
...
typedef struct UBX_CFG_ANT_POLL0_s
{

} UBX_CFG_ANT_POLL0_t, *UBX_CFG_ANT_POLL0_pt;
...
typedef struct UBX_CFG_DAT_POLL0_s
{

} UBX_CFG_DAT_POLL0_t, *UBX_CFG_DAT_POLL0_pt;
...
//================================================================
//! CFG_DOSC_POLL0: Poll Request
/*!
Poll DOSC settings
Sending this message to the receiver results in the receiver returning a message of type CFG-DOSC-DATA0 with a payload as defined below for the oscillator specified
...
typedef struct UBX_CFG_DOSC_POLL0_s
{

} UBX_CFG_DOSC_POLL0_t, *UBX_CFG_DOSC_POLL0_pt;
...
//#define UBXID_CFG_DOSC 0x0661  // already defined, see above


//================================================================
//! CFG_ESRC_POLL0: Poll Request
/*!
Poll ESRC settings
-
...
typedef struct UBX_CFG_ESRC_POLL0_s
{

} UBX_CFG_ESRC_POLL0_t, *UBX_CFG_ESRC_POLL0_pt;
...
//#define UBXID_CFG_ESRC 0x0660  // already defined, see above


//================================================================
//! CFG_GNSS_POLL0: Poll Request
/*!
...
typedef struct UBX_CFG_GNSS_POLL0_s
{

} UBX_CFG_GNSS_POLL0_t, *UBX_CFG_GNSS_POLL0_pt;
...
The number of tracking channels in use must not exceed the number of tracking channels available in hardware, and the sum of all reserved tracking channels needs to be less than or equal to the number of tracking channels in use. Additionally, the maximum number of tracking channels used for the specific GNSS system must be greater or equal to the number of reserved tracking channels.
...
Note that GLONASS or BeiDou operation cannot be selected when the receiver is configured to operate in Power Save Mode (using <rc href=\"UBX-CFG-RXM'>UBX-CFG-RXM</rc>).
GPS and QZSS should always be either both enabled or both disabled.
...
typedef struct UBX_CFG_GNSS_DATA0_s
{
	...
	U1  numTrkChUse;              //!< Number of tracking channels to use (<= numTrkChHw)
...
{
	U1  gnssId;                   //!< GNSS identifier (see <r href=\"DESC-SVNumbering-UBX'>Satellite Numbering</r>)
	U1  resTrkCh;                 //!< Number of reserved (minimum) tracking channels for this GNSS system
	U1  maxTrkCh;                 //!< Maximum number of tracking channels used for this GNSS system (>=resTrkChn)
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	X4  flags;                    //!< bitfield of flags
...
//#define UBXID_CFG_GNSS 0x063E  // already defined, see above
...
typedef struct UBX_CFG_ITFM_POLL0_s
{

} UBX_CFG_ITFM_POLL0_t, *UBX_CFG_ITFM_POLL0_pt;
...
//#define UBXID_CFG_ITFM 0x0639  // already defined, see above


//================================================================
//! CFG_LOGFILTER_POLL0: Poll Request
/*!
...
typedef struct UBX_CFG_LOGFILTER_POLL0_s
{

} UBX_CFG_LOGFILTER_POLL0_t, *UBX_CFG_LOGFILTER_POLL0_pt;
...
//================================================================
//! CFG_LOGFILTER_DATA0: Input/Output
/*!
Data Logger Configuration
This message is used to enable/disable logging and to get or set the position entry filter settings.
Position entries can be filtered based on time difference, position difference or current speed thresholds. Position and speed filtering also have a minimum time interval.
A position is logged if any of the thresholds are exceeded. If a threshold is set to zero it is ignored. The maximum rate of position logging is 1Hz.
The filter settings will only be applied if the 'applyAllFilterSettings' flag is set. This enables recording to be enabled/disabled without affecting the other settings.
...
//#define UBXID_CFG_LOGFILTER 0x0647  // already defined, see above
...
//================================================================
//! CFG_MSG_SETCURRENT: Input/Output
/*!
Set Message Rate
...
typedef struct UBX_CFG_NAV5_POLL0_s
{

} UBX_CFG_NAV5_POLL0_t, *UBX_CFG_NAV5_POLL0_pt;
...
//================================================================
//! CFG_NAVX5_POLL0: Poll Request
/*!
Poll Navigation Engine Expert Settings
Sending this (empty / no-payload) message to the receiver results in the receiver returning a message of type CFG-NAVX5 with a payload as defined below.
...
typedef struct UBX_CFG_NAVX5_POLL0_s
{

} UBX_CFG_NAVX5_POLL0_t, *UBX_CFG_NAVX5_POLL0_pt;
...
typedef struct UBX_CFG_NAVX5_DATA0_s
{
	...
	U1  useAdr;                   //!< <i>Only supported on certain product variants</i>
...
typedef struct UBX_CFG_NMEA_POLL0_s
{

} UBX_CFG_NMEA_POLL0_t, *UBX_CFG_NMEA_POLL0_pt;
...
//================================================================
//! CFG_ODO_POLL1: Poll Request
/*!
Poll Odometer, Low-speed COG Engine Settings
Sending this (empty / no-payload) message to the receiver results in the receiver returning a message of type CFG-ODO with a payload as defined below.
...
typedef struct UBX_CFG_ODO_POLL1_s
{

} UBX_CFG_ODO_POLL1_t, *UBX_CFG_ODO_POLL1_pt;
...
//#define UBXID_CFG_ODO 0x061E  // already defined, see above


//================================================================
//! CFG_PM2_POLL0: Poll Request
/*!
...
typedef struct UBX_CFG_PM2_POLL0_s
{

} UBX_CFG_PM2_POLL0_t, *UBX_CFG_PM2_POLL0_pt;
...
//================================================================
//! CFG_PM2_DATA0: Input/Output
/*!
Extended Power Management configuration
-

   \note: This feature is not supported for either the ADR or FTS product variants.
...
typedef struct UBX_CFG_PM2_DATA0_s
{
	...
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	U1  maxStartupStateDur;       //!< Maximum time to spend in <i>Acquisition</i> state. If 0: bound disabled (see <r href=\"PM-DESC-MAXSTARTUPSTATEDUR'>maxStartupStateDur</r>). (Only supported in <r href='ProtocolVersions'>protocol versions 17+</r>)
	U1  reserved2;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
typedef struct UBX_CFG_PRT_POLL0_s
{

} UBX_CFG_PRT_POLL0_t, *UBX_CFG_PRT_POLL0_pt;
...
typedef struct UBX_CFG_RATE_POLL0_s
{

} UBX_CFG_RATE_POLL0_t, *UBX_CFG_RATE_POLL0_pt;
...
typedef struct UBX_CFG_RATE_DATA0_s
{
	...
	U2  navRate;                  //!< Navigation Rate, in number of measurement cycles. This parameter cannot be changed, and must be set to 1.
	U2  timeRef;                  //!< Alignment to reference time
...
typedef struct UBX_CFG_RINV_POLL0_s
{

} UBX_CFG_RINV_POLL0_t, *UBX_CFG_RINV_POLL0_pt;
...
//#define UBXID_CFG_RINV 0x0634  // already defined, see above
...
typedef struct UBX_CFG_RXM_POLL0_s
{

} UBX_CFG_RXM_POLL0_t, *UBX_CFG_RXM_POLL0_pt;
...
typedef struct UBX_CFG_SBAS_POLL0_s
{

} UBX_CFG_SBAS_POLL0_t, *UBX_CFG_SBAS_POLL0_pt;
...
typedef struct UBX_CFG_SBAS_U5_s
{
	X1  mode;                     //!< SBAS Mode
	X1  usage;                    //!< SBAS Usage
	U1  maxSBAS;                  //!< Maximum Number of SBAS prioritized tracking channels (valid range: 0 - 3) to use (obsolete and superseeded by UBX-CFG-GNSS in <r href='ProtocolVersions'>protocol versions 14+</r>).
...
//#define UBXID_CFG_SBAS 0x0616  // already defined, see above


//================================================================
//! CFG_SMGR_POLL0: Poll Request
/*!
Poll SMGR settings
-
...
typedef struct UBX_CFG_SMGR_POLL0_s
{

} UBX_CFG_SMGR_POLL0_t, *UBX_CFG_SMGR_POLL0_pt;
...
//#define UBXID_CFG_SMGR 0x0662  // already defined, see above


//================================================================
//! CFG_TMODE2_POLL0: Poll Request
/*!
Poll Time Mode Settings
Sending this (empty / no-payload) message to the receiver results in the receiver returning a message of type CFG-TMODE2 with a payload as defined below
...
typedef struct UBX_CFG_TMODE2_POLL0_s
{

} UBX_CFG_TMODE2_POLL0_t, *UBX_CFG_TMODE2_POLL0_pt;
...
//#define UBXID_CFG_TMODE2 0x063D  // already defined, see above
...
{
	U1  tpIdx;                    //!< Time pulse selection (0 = TIMEPULSE, 1 = TIMEPULSE2)
	U1  version;                  //!< Version, 0 for this message
	U1  reserved1[2];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  tpIdx;                    //!< Time pulse selection (0 = TIMEPULSE, 1 = TIMEPULSE2)
	U1  version;                  //!< Version, 1 for this message
	U1  reserved1[2];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	I2  antCableDelay;            //!< Antenna cable delay
	I2  rfGroupDelay;             //!< RF group delay
	U4  freqPeriod;               //!< Frequency or period time, depending on setting of bit 'isFreq'
...
typedef struct UBX_CFG_USB_POLL0_s
{

} UBX_CFG_USB_POLL0_t, *UBX_CFG_USB_POLL0_pt;
...
This message can be used to search a log for the index of the first entry less than or equal to the given time. This index can then be used with the <rc href=\"UBX-LOG-RETRIEVE'>UBX-LOG-RETRIEVE</rc> message to provide time-based retrieval of log entries.
...
typedef struct UBX_LOG_FINDTIME_RESPONSE_s
{
	...
	U1  reserved1[2];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	U4  entryNumber;              //!< Index of the most recent entry with time <= specified
...
typedef struct UBX_LOG_RETRIEVEPOSEXTRA_ODOMETER0_s
{
	...
	U4  distance;                 //!< Odometer distance traveled
...
Log entries are returned in chronological order, using the messages <rc href=\"UBX-LOG-RETRIEVEPOS'>UBX-LOG-RETRIEVEPOS</rc> and <rc href=\"UBX-LOG-RETRIEVESTRING'>UBX-LOG-RETRIEVESTRING</rc>. The maximum number of entries that can be returned in response to a single UBX-LOG-RETRIEVE message is 256. If more entries than this are required the mesage will need to be sent multiple times with different startNumbers. The retrieve will be stopped if any UBX-LOG message is received. The speed of transfer can be maximized by using a high data rate and temporarily stopping the GPS processing (see <rc href=\"UBX-CFG-RST'>UBX-CFG-RST</rc>)
...
{
	U4  startNumber;              //!< Index of first entry to be transferred
	U4  entryCount;               //!< Number of log entries to transfer. The maximum is 256
	U1  version;                  //!< The version of this message. Set to 0
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
This message is sent by a u-blox receiver to acknowledge the receipt of an assistance message. Acknowledgements are enabled by setting the ackAiding parameter in the <rc href=\"UBX-CFG-NAVX5'>UBX-CFG-NAVX5</rc> message. See the description of <r href=\"MGA-FlowControl'>flow control</r> for details.
...
{
	U1  type;                     //!< Type, 1 = ACK, 0 = NACK
	U1  version;                  //!< The version of this message, always set to 0
	U1  errorCode;                //!< Indicates the reason why a NACK was returned:
	U1  msg_id;                    //!< UBX message ID of the ack'ed message
...
{
	U1  type;                     //!< message type (always 0x00)
	U1  version;                  //!< message version (always 0x00)
	U1  svId;                     //!< Satellite identifier (see <r href=\"DESC-SVNumbering-UBX'>Satellite Numbering</r>)
	U1  gnssId;                   //!< GNSS identifier (see <r href=\"DESC-SVNumbering-UBX'>Satellite Numbering</r>)
...
Navigation database entry. The data fields are firmware specific. Transmission of this type of message will be acknowledged by <rc href=\"UBX-MGA-ACK'>MGA-ACK</rc> messages, if acknowledgement has been enabled (see the description of <r href=\"MGA-FlowControl'>flow control</r> for details).
The maximum payload size for firmware 2.01 is 164 bytes (which makes the maximum message size 172 bytes).
...
{
	U1  type;                     //!< Message type. Set to 1 for this message.
	U1  version;                  //!< FLASH-DATA message version (this is version 0).
...
{
	U1  type;                     //!< Message type. Set to 2 for this message.
	U1  version;                  //!< FLASH-STOP message version (this is version 0).
...
{
	U1  type;                     //!< Message type. Set to 3 for this message.
	U1  version;                  //!< FLASH-ACK message version (this is version 0).
	U1  ack;                      //!< Acknowledgement type. 0 - ACK: Message received and written to flash. 1 - NACK: Problem with last message, re-transmission required (this only happens while acknowledging a UBX-MGA_FLASH_DATA message). 2 - NACK: problem with last message, give up.
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 1 for this message (1 = Ephemeris).
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 2 for this message (2 = Almanac).
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	U1  svId;                     //!< GLONASS Satellite identifier (see <r href=\"DESC-SVNumbering-UBX'>Satellite Numbering</r>)
	U1  reserved2;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 3 for this message (3 = time offsets).
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 4 for this message (4 = health flags).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 5 for this message (5 = Time parameters).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 6 for this message (6 = ionosphere parameters).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 0x00 for this message (0x00 = Position - ECEF - XYZ).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 0x01 for this message (0x01 = Position - ECEF - LLA).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 0x10 for this message (0x10 = Time).
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 0x11 for this message (0x11 = Time GNSS).
	U1  reserved1;                //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	X1  ref;                      //!< Reference to be used to set time
...
{
	U1  type;                     //!< Message type. Set to 0x20 for this message (0x20 = Clock Drift).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	I4  clkD;                     //!< Clock drift
...
{
	U1  type;                     //!< Message type. Set to 0x21 for this message (0x21 = Frequency).
	U1  reserved1[2];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	U1  type;                     //!< Message type. Set to 0x30 for this message (0x30 = EOP).
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
//================================================================
//! MON_GNSS_DATA0: Output
/*!
Information message GNSS selection
This message reports GNSS system selection. It does this be means of bit masks in U1 fields. Each bit in a bit mask corresponds to one GNSS system. Systems such as SBAS and QZSS are not reported. If systems such as SBAS/QZSS are related to one GNSS system (GPS is these cases), then they will be disabled when the related system is disabled.
...
{
	U1  version;                  //!< Type of the message, 1 for this type
	X1  Supported;                //!< A bit mask, saying which GNSS systems can be supported by this receiver
	X1  Default;                  //!< A bit mask, saying which GNSS systems are enabled in the current efuse default configuration for this receiver
	X1  Enabled;                  //!< A bit mask, saying which GNSS systems are currently enabled for this receiver
	U1  Simultaneous;             //!< Maximum number of concurrent GNSS systems which can be supported by this receiver
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
//@}
//! \name Bit Definitions for #UBX_MON_GNSS_DATA0_s::Default
//@{
#define UBX_MON_GNSS_DATA0_DEFAULT_GPSDEF_MASK 0x01  //!< Mask for field GPSDef in bitmask Default
#define UBX_MON_GNSS_DATA0_DEFAULT_GPSDEF_GET(val)  (U)(((val)&UBX_MON_GNSS_DATA0_DEFAULT_GPSDEF_MASK)>>0)  //!< Get GPSDef from bitmask Default
#define UBX_MON_GNSS_DATA0_DEFAULT_GLONASSDEF_MASK 0x02  //!< Mask for field GlonassDef in bitmask Default
#define UBX_MON_GNSS_DATA0_DEFAULT_GLONASSDEF_GET(val)  (U)(((val)&UBX_MON_GNSS_DATA0_DEFAULT_GLONASSDEF_MASK)>>1)  //!< Get GlonassDef from bitmask Default
#define UBX_MON_GNSS_DATA0_DEFAULT_BEIDOUDEF_MASK 0x04  //!< Mask for field BeidouDef in bitmask Default
#define UBX_MON_GNSS_DATA0_DEFAULT_BEIDOUDEF_GET(val)  (U)(((val)&UBX_MON_GNSS_DATA0_DEFAULT_BEIDOUDEF_MASK)>>2)  //!< Get BeidouDef from bitmask Default
...
typedef struct UBX_MON_HW2_DATA0_s
{
	...
	U1  reserved1[3];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	U4  lowLevCfg;                //!< Low-level configuration (obsolete, only use this field if the message MON-LLC is not available in your receiver)
	U1  reserved2[8];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
...
{
	CH  extension[30];            //!< Extended receiver/software information.
...
typedef struct UBX_NAV_PVT_DATA1_s
{
	...
	U1  flags2;                   //  update based on M10 ICD</r>
	...
	U2  pDOP;                     //!< Position DOP
	X2  flags3;					  // update based on M10 ICD
	U1  reserved2[4];             //!< <r href='DESC-UBX-Reserved'>Reserved</r>
	I4  headVeh;                  //!< Heading of vehicle (2-D)
	I2  magDec;                   // magnetic declination, udpate based M10 IDC
	U2  magAcc;                   // magnetic declination accuracy update based on M10 ICD
...
typedef struct UBX_NAV_SAT_DATA0_GNSSID_s
{
	...
	I2  azim;                     //!< Azimuth (range +/-180), unknown if elevation is out of range
...
//================================================================
//! RXM_SFRBX_DATA1: Aperiodic
/*!
Raw Subframe Data
This message sends the raw data received from a certain satellite system (including <r href=\"IMES-DESC'>IMES</r>). Thus the message contains preamble, parity bits and all protocol specific overhead and is sent out when new data is received from the transmitter.
Note that for IMES transmitters the <c>dwrd</c> can contain data of only one IMES frame but also data of multiple frames. For example, it could contain a single 1-word long short ID frame only, in this case <c>numWords</c> is 1, but it could also contain a 1-word long short ID frame and a 3-word long position 1 frame, then <c>numWords</c> would be 4. For details on the data format, please check IS-QZSS Version 1.5.

   \note: This is an extended, more flexible version of RXM-SFRB.
...
/*!
Source measurement
Frequency and/or phase measurement of syncronization sources. The measurements are relative to the nominal frequency and nominal phase.
...
Calibrate (measure) gain of the voltage controlled oscillator. The calibration is performed by varying the raw oscillator control values between the limits specified in raw0 amd raw1. maxStepSize is the largest step change that can be used during the calibration process. The \"raw values\" are either PWM duty cycle values or DAC values depending on how the VCTCXO is connected to the system. The measured gain is the transfer function dRelativeFrequencyChange/dRaw (not dFrequency/dVoltage). The calibration process works as follows:
